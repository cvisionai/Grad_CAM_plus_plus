...
def run(filename_list, class_label, out_dir):
    arch_path = '/mnt/md0/Projects/FathomNet/Training_Files/Benthic/snapshots/'
    epoch = 33
    nb_classes = 12
    mean_img_path = '/mnt/md0/Projects/FathomNet/Training_Files/Benthic/mean_image.png'
...
def main():
    ...
    parser.add_argument('-b', '--batch_size', default=256, type=int, help="Number of images to process in a batch")
